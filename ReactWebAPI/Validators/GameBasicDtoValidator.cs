...
public class GameBasicDtoValidator : AbstractValidator<GameBasicDto>
{
    public GameBasicDtoValidator()
    {
        RuleFor(x => x.Title)
        ...
        RuleFor(x => x.ImageUrl)
           ...
           .Must(BeValidImagePath).WithMessage("Image URL must be a valid path (e.g., Images/game.jpg)");
    }
